...
#
# AES_EBC_128_ip_check.tcl: Tcl script for re-creating project 'AES_EBC_128_ip_check'
#
...
#
# 1. This project restoration tcl script (AES_EBC_128_ip_check.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "Block_Design/hdl/AES_EBC_128_design_wrapper.v"
...
set _xil_proj_name_ "AES_EBC_128"
...
set script_file "AES_EBC_128_ip_check.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../AES_EBC_128_ip_check"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "Block_Design/AES_EBC_128_ip"]" $obj
...
set files [list \
 [file normalize "Block_Design/hdl/AES_EBC_128_design_wrapper.v" ]\
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "AES_EBC_128_design_wrapper" -objects $obj
...
# Proc to create BD AES_EBC_128_design
proc cr_bd_AES_EBC_128_design { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name AES_EBC_128_design
  ...
  if { $bCheckIPs == 1 } {
     set list_check_ips "\ 
  xilinx.com:user:AES_EBC_128:1.0\
  ...
  # Create instance: AES_EBC_128_0, and set properties
  set AES_EBC_128_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:AES_EBC_128:1.0 AES_EBC_128_0 ]
  ...
  connect_bd_intf_net -intf_net AES_EBC_128_0_m00_axis [get_bd_intf_pins AES_EBC_128_0/m00_axis] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_1_M_AXIS [get_bd_intf_pins AES_EBC_128_0/s00_axis] [get_bd_intf_pins axis_data_fifo_1/M_AXIS]
...
# End of cr_bd_AES_EBC_128_design()
cr_bd_AES_EBC_128_design ""
set_property REGISTERED_WITH_MANAGER "1" [get_files AES_EBC_128_design.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files AES_EBC_128_design.bd ] 
