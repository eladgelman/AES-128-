...
#
# AES_ECB_128_ip_check.tcl: Tcl script for re-creating project 'AES_ECB_128_ip_check'
#
# Generated by Vivado on Sun Nov 24 12:20:38 +0200 2024
...
#
# 1. This project restoration tcl script (AES_ECB_128_ip_check.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "Block_Design/hdl/AES_ECB_128_design_wrapper.v"
#    "Block_Design/constraints/switch_led.xdc"
#
...
set _xil_proj_name_ "AES_ECB_128"
...
set script_file "aes_ecb_128_script.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../AES_ECB_128_ip_check"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "Block_Design/AES_ECB_128_ip"]" $obj
...
set files [list \
 [file normalize "Block_Design/hdl/AES_ECB_128_design_wrapper.v" ]\
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "AES_ECB_128_design_wrapper" -objects $obj
...
set file "[file normalize "Block_Design/constraints/switch_led.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "constraints/switch_led.xdc"
...
# Proc to create BD AES_ECB_128_design
proc cr_bd_AES_ECB_128_design { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name AES_ECB_128_design
  ...
  if { $bCheckIPs == 1 } {
     set list_check_ips "\ 
  xilinx.com:user:AES_ECB_128:1.0\
  ...
  # Create ports
  set LD4_port [ create_bd_port -dir O -from 2 -to 0 LD4_port ]
  set sw1 [ create_bd_port -dir I sw1 ]

  # Create instance: AES_ECB_128_0, and set properties
  set AES_ECB_128_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:AES_ECB_128:1.0 AES_ECB_128_0 ]
  ...
  connect_bd_intf_net -intf_net AES_ECB_128_0_m00_axis [get_bd_intf_pins AES_ECB_128_0/m00_axis] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_1_M_AXIS [get_bd_intf_pins AES_ECB_128_0/s00_axis] [get_bd_intf_pins axis_data_fifo_1/M_AXIS]
  ...
  connect_bd_net -net AES_ECB_128_0_LD4_rgb [get_bd_ports LD4_port] [get_bd_pins AES_ECB_128_0/LD4_rgb] [get_bd_pins axi_gpio_0/gpio_io_i]
  connect_bd_net -net en_decrypt_0_1 [get_bd_ports sw1] [get_bd_pins AES_ECB_128_0/en_decrypt]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AES_ECB_128_0/s00_axis_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins AES_ECB_128_0/s00_axis_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
...
# End of cr_bd_AES_ECB_128_design()
cr_bd_AES_ECB_128_design ""
set_property REGISTERED_WITH_MANAGER "1" [get_files AES_ECB_128_design.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files AES_ECB_128_design.bd ] 
