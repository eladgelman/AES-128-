...
HD_PWD='C:/Users/User/AES_CBC_128_ip_check/AES_CBC_128_ip_check.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_CBC_128_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AES_CBC_128_design_wrapper.tcl -notrace
