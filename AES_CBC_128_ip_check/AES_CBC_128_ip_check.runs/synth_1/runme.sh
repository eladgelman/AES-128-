...
HD_PWD='C:/Users/User/AES_CBC_128_ip_check/AES_CBC_128_ip_check.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_CBC_128_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AES_CBC_128_design_wrapper.tcl
