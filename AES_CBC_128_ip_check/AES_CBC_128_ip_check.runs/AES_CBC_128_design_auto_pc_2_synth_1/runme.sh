...
HD_PWD='C:/Users/User/AES_CBC_128_ip_check/AES_CBC_128_ip_check.runs/AES_CBC_128_design_auto_pc_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_CBC_128_design_auto_pc_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AES_CBC_128_design_auto_pc_2.tcl
