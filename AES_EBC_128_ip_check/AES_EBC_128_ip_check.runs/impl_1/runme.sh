...
HD_PWD='C:/Users/User/AES_EBC_128_ip_check/AES_EBC_128_ip_check.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_EBC_128_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AES_EBC_128_design_wrapper.tcl -notrace
