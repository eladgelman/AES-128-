...
HD_PWD='C:/Users/User/AES_EBC_128_ip_check/AES_EBC_128_ip_check.runs/AES_EBC_128_design_axis_data_fifo_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_EBC_128_design_axis_data_fifo_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AES_EBC_128_design_axis_data_fifo_0_1.tcl
